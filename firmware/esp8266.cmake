...
set(ESP8266_LDFLAGS "-L${ESP_TOOLCHAIN_DIR}/../lib/gcc/xtensa-lx106-elf/4.8.2/ -L${ESP_SDK_BASE}/lib -T${ESP8266_LINKSCRIPT} -nostdlib -u call_user_start -static --start-group ${ESP8266_LIBS} -lesp-platform -lkaac_s -l${APP_NAME}_s --end-group --gc-sections -Map map")

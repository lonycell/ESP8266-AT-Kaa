...
extern void cmd_parser_task(void *pvParameters);
...
uart_init_new(void)
{
    ...
    xTaskCreate(cmd_parser_task, "", DEFAULT_STACK_SIZE, NULL, tskIDLE_PRIORITY+2, NULL );
    xQueueUart = xQueueCreate(8, sizeof(uint8_t));  
